...
| 20 | Repositorio de entrega | **B · Rama aparte (`anexo-otel`)** | El challenge principal queda congelado en `main` y el anexo se lee como un diff limpio sobre esa base. Pesó que el anexo terminó tocando código del challenge principal (`ApiExceptionHandler`, `build.gradle`, wrapper de Gradle): en `main` eso se habría mezclado con la entrega anterior sin distinción. |
