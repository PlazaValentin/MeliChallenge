...
public class JacksonConfig {
     ...
     * valida el dominio, pero se declara aparte porque aquella es una invariante del
     * modelo y esta es una regla de presentacion: son la misma cifra por decision, no
     * por dependencia.
     */
     ...
     * valor. Se resuelve una sola vez en la serializacion y no monto por monto, para
     * que ningun campo nuevo pueda olvidarse de aplicarlo.
     *
     * <p>
     * El redondeo es defensivo: los montos ya llegan con la escala correcta validada
